...
export default function Footer() {
  return (
    <footer>
      <div
        className="py-12 md:py-4 px-4"
        style={{ backgroundColor: "rgba(2, 6, 23, 1)" }}
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          {/* Top area: Blocks */}
          <div className="grid md:grid-cols-12 gap-4 lg:gap-36 mb-8 md:mb-12">
            {/* 1st block */}
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400 text-md text-justify">
                Experience the game-changing expertise of our Stripe payment
                gateway experts who will architect, integrate, and deploy a
                tailor-made Stripe solution to meet your unique business
                requirements. Partner with us today and unlock the potential of
                an optimized payment solution that maximizes revenue and
                customer satisfaction. Contact us now and let's embark on this
                exciting journey together!
              </div>
            </div>

            {/* 2nd, 3rd and 4th blocks */}
            <div className="md:col-span-8 lg:col-span-5 grid sm:grid-cols-2 gap-0 mt-10">
              {/* 2nd block */}
              <div className="text-sm">
                <span className="text-sky-500 font-ethnocentric text-md mb-1">
                  Life At Crabroom
                </span>
                <ul>
                  ...
                  <li className="mb-1">
                    <Link
                      ...
                      className="text-gray-400 hover:text-gray-100 transition duration-150 text-base ease-in-out"
                    >
                      Schedule Job Interview (for pre-screened candidates only)
                    </Link>
                  </li>
                </ul>
              </div>
              ...
              {/* 4th block */}
              {/* <div className="text-sm">
                <span className="text-gray-200 font-medium text-lg mb-1">Company</span>
                <ul>
                  <li className="mb-1">
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 text-base ease-in-out">About</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 text-base ease-in-out">Team</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 text-base ease-in-out">Ethos</Link>
                  </li> */}
          ...
          <div className="md:flex md:items-center md:justify-between mt-14">
            ...
            {/* Copyrights note */}
            {/*<div className="text-gray-400 text-base mr-4">&copy; merci-buku.com. All rights reserved.</div>*/}
            <div className="container lg:mx-auto">
              <div className="mb-1 text-center text-gray-400 text-sm">
                All Rights Reserved. |
                <Link href={"/privacypolicy"} className="text-sky-500 hover:text-sky-600 text-sm mx-2">
                  Privacy Policy
                </Link>{" "}
                |
                <Link href={"/termsconditions"} className="text-sky-500 hover:text-sky-600 text-sm mx-2">
                  Terms & Conditions
                </Link>{" "}
                |
                <Link href={"/contactus"} className="text-sky-500 hover:text-sky-600 text-sm mx-2">
                  Contact Us
                </Link>
              </div>

              <div className="mb-4 text-center text-gray-400 text-base">
                <span>
                  ©2018
                  {new Date().getFullYear() > 2018 &&
                    `-${new Date().getFullYear()}`}{" "}
                  Crabroom PayInt LLC, 201 Washington Street, Suite 2600,
                  Boston, MA, USA 02108
                </span>
              </div>
            </div>
