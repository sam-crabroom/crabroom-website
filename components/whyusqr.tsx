    ...
    <section className="py-16" style={{ backgroundColor: '#020617' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center pb-8">
          <h2 className="text-xl font-ethnocentric mb-4">The benefits of this partnership extend across the ecosystem:</h2>
        </div>

        {/* Partnership benefits */}
        <div className="grid gap-8 md:grid-cols-1 lg:grid-cols-2 lg:gap-12">
          {/* Manufacturers Benefit */}
          <div className="bg-sky-500 p-6 md:p-8 rounded-3xl shadow-md">
            <h3 className="text-xl  text-slate-200 font-ethnocentric mb-4">Manufacturers</h3>
          ...
          {/* End Buyers Benefit */}
          <div className="bg-sky-500 p-6 md:p-8 rounded-3xl shadow-md">
            <h3 className="text-xl font-ethnocentric mb-4 text-slate-200">End Buyers</h3>
            <p className="text-slate-200">
