...
import LoaderWithFacts from "./LoaderWithFacts";
import ContactForm from "./ContactForm";
import { getCountries } from "country-state-picker";
import { getAllCurrencies } from "./currencyAPI";
...
import '../app/css/additional-styles/globa.css'
...
export default function Home() {
          ...
          <form className="flex items-center">
            ...
            <div className="relative w-full">
              ...
              <input
                type="text"
                id="simple-search"
                className="bg-gray-100 border min-w-72 border-gray-200 text-gray-900 text-sm rounded-lg focus:outline-none block w-72 pl-10 p-2 dark:placeholder-gray-400 dark:text-black"
                placeholder="Search"
                value={searchTerm}
            ...
            <div className="ml-2">
              <button
                type="button"
                className="mt-2 px-4 py-2 mb-2 text-white rounded-md transition-colors w-60 bg-cyan-500 min-w-60"
          ...
          <table className="rounded-lg">
            <thead className=" bg-cyan-500 text-white rounded-md">
              <tr>
                ...
                <th className="border border-gray-200 px-4 py-2 font-semibold rounded-lg w-full min-w-60">
                  <div className="w-32">
                  Payment Gateway Name
                  </div>
                </th>
                <th className="border border-gray-200 px-4 py-2 w-72 font-semibold rounded-lg relative">
                ...
                <th className="border border-gray-200 px-4 py-2 min-w-60 font-semibold rounded-lg relative w-96">
            ...
            <tbody className="rounded-lg">
              ...
              selectedCurrencies.length === 0
                ...
                >
                  ...
                  <td className="border border-gray-200 px-4 py-2 text-cyan-900 w-60">
                    {gateway["Payment Gateway Name"]}
                  </td>
  ...
  return (
      <div>
      <main className="flex flex-col min-h-screen items-center justify-center p-8 sm:p-16 md:p-24 lg:p-32 xl:p-28">
        <div className="flex flex-col items-start justify-center w-3/4 max-w-full rounded-xl p-4">
          <div className="flex items-center justify-end w-full mb-1 gap-2">
            <input
              ...
              className="bg h-4 w-4 border border-gray-400 rounded checked:bg-cyan-600 checked:border-transparent focus:outline-none focus:bg-black"
            />
            <label
              ...
              <label className="flex cursor-pointer select-none items-center ml-2 mr-2">
                <div className="relative">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className=" h-10 w-60 rounded-full bg-cyan-500 shadow-md shadow-cyan-600 flex justify-between items-center px-4">
          ...
          <div className="w-full mb-4 text-black rounded-md relative mt-4 flex">
            ...
            <button
              type="button"
              className={`mb-2 ml-2 h-20 text-white transition-colors min-w-96 w-24 rounded-3xl shadow-md shadow-cyan-600
                ${
                  isButtonDisabled
