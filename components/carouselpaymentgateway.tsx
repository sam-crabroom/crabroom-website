...
const ReviewSlider = () => {
  ...
  return (
    <div className="rbd-core-ui  rounded-3xl">
      <h1 className="pt-10 text-xl text-sky-500 font-ethnocentric text-center pb-20">
      ...
      <div className="rbd-review-slider">
        <div className="rbd-review-container">
          <div className="rbd-review review1.1 rbd-curr">
            ...
            <div className="rbd-content text-slate-500">
              "Highly recommend! This efficiently reduced our time in searching
              and comparing POS solutions online, making it incredibly
              effective.""
            </div>
            <div className="rbd-review-meta">
              - Michael Thompson, USA. on Jan 15, 2024
            </div>
          </div>
          <div className="rbd-review review1.2 rbd-next">
            ...
            <i className="renderSVG" data-icon="star" data-repeat="5"></i>
            <div className="rbd-content text-slate-500">
              "While the tool gave us a fair go at making a decision, having a
              yarn for some advice turned out ace. The team led the way and
              chucked in the payment gateway quick smart."
            </div>
            <div className="rbd-footing"></div>
            <div className="rbd-review-meta">
              - Emma Johnson, Australia. on Feb 8, 2024
            </div>
          </div>
          <div className="rbd-review review1.3">
            ...
            <i className="renderSVG" data-icon="star" data-repeat="5"></i>
            <div className="rbd-content text-slate-500">
              "It's a game-changer for our business! Utilising this AI tool, we
              found a cheaper solution and saved thousands of dollars a month.
              Brilliant!"
            </div>
            ...
            <div className="rbd-review-meta">
              - Jessica Smith, Canada. on Feb 20, 2024
            </div>
          </div>
          <div className="rbd-review review1.4">
            ...
            <i className="renderSVG" data-icon="star" data-repeat="5"></i>
            <div className="rbd-content text-slate-500">
              "It saved us time and resources while optimising our payment
              processes. I loved how this tool utilises AI to compare
              shortlisted gateways, focusing on my specific requirements. It's a
              game-changer!"
            </div>
            <div className="rbd-review-meta">
              -Alexander Lee, UK. on Jan 20, 2024
            </div>
          </div>
          <div className="rbd-review review1.7">
            ...
            <i className="renderSVG" data-icon="star" data-repeat="5"></i>
            <div className="rbd-content text-slate-500">
              "It guided us to the perfect payment gateway, enhancing our
              business operations significantly. Initially, we spent a week
              choosing a payment gateway, but this tool helped me finish the
              task in 5 mins. The AI-powered tips were incredibly helpful!"
            </div>
            <div className="rbd-review-meta">
              - Daniel Nguyen, Vietnam. on Mar 1, 2024
            </div>
          </div>
        </div>
      </div>
