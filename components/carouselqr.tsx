...
const ReviewSlider = () => {
    ...
    return (
        ...
        <div className="rbd-core-ui">
            <h1 className='text-center h2 p-10'>Our Favourite Reviews: </h1>
            <div className="rbd-review-slider">
                <div className="rbd-review-container">
                    <div className="rbd-review review1.1 rbd-curr">
                        ...
                        <div className="rbd-content">"Highly recommend! This efficiently reduced our time in searching and comparing POS solutions online, making it incredibly effective.""</div>
                    ...
                    <div className="rbd-review review1.2 rbd-next">
                        ...
                        <i className="renderSVG" data-icon="star" data-repeat="5"></i>
                        <div className="rbd-content">"While the tool gave us a fair go at making a decision, having a yarn for some advice turned out ace. The team led the way and chucked in the payment gateway quick smart."</div>
                    ...
                    <div className="rbd-review review1.3">
                        ...
                        <i className="renderSVG" data-icon="star" data-repeat="5"></i>
                        <div className="rbd-content">"It's a game-changer for our business! Utilising this AI tool, we found a cheaper solution and saved thousands of dollars a month. Brilliant!"</div>
                        <div className="rbd-footing">
                    ...
                    <div className="rbd-review review1.4">
                        ...
                        <i className="renderSVG" data-icon="star" data-repeat="5"></i>
                        <div className="rbd-content">"It saved us time and resources while optimising our payment processes. I loved how this tool utilises AI to compare shortlisted gateways, focusing on my specific requirements. It's a game-changer!"</div>
                    ...
                    <div className="rbd-review review1.7">
                        ...
                        <i className="renderSVG" data-icon="star" data-repeat="5"></i>
                        <div className="rbd-content">"It guided us to the perfect payment gateway, enhancing our business operations significantly. Initially, we spent a week choosing a payment gateway, but this tool helped me finish the task in 5 mins. The AI-powered tips were incredibly helpful!"</div>
