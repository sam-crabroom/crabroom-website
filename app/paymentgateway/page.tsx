    ...
    <>
      <main className="grow">
        <div className="max-w-3xl mx-auto text-center pb-10 md:pb-5 mt-10">
          <h2 className="text-2xl mb-4 text-sky-500 font-ethnocentric pb-2">
            Payment Gateway-POS Matchmaker
          </h2>
          <p className="text-md text-white font-ethnocentric ">
            Your Payment Solution Advisor: Effortlessly select the ideal payment
            gateway or POS system!
          </p>
        </div>
        ...
        <div className="mt-4 flex justify-content-center justify-center align-items-center pb-10">
          <video
            className="w-96 h-auto border border-gray-200 rounded-xl dark:border-gray-700"
            controls
          >
